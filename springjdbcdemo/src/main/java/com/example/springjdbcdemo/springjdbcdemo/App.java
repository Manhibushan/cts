package com.example.springjdbcdemo.springjdbcdemo;
...
import com.example.springjdbcdemo.springjdbcdemo.bean.Customer;
import com.example.springjdbcdemo.springjdbcdemo.bean.Customerservice;
   	...
   	do {
   		...
   		switch (choice) {
			case 1:
				...
				uId=arr[0]+arr[1];
				service.createCustomer(new Customer(firstName, lastName, email,uId));
